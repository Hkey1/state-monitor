module.exports = async (req, {isActive, childs, url, width, details, name, badge}, item)=>`
	<div id="sidebar" 
		...
		<div class="smon-server-link-div">
			<a href="${url}" 
			  class="smon-server-link d-flex align-items-center mb-3 mb-md-0 me-md-auto link-dark text-decoration-none ${isActive ? 'active':''}">
				<span class="fs-4 smon-server-name">${name} ${await item.template('badge', req, {content: badge})}</span>
			</a>
		</div>
